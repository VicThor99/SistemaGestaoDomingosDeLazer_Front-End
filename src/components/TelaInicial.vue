...
export default {
    ...
    methods: {
        async carregarDashboard() {
            ...
            const res = await axios.get('http://172.31.87.236:8080/api/dashboard/' + this.escola, {
                headers: {
        ...
        carregarLista(opcao) {
            switch (opcao) {
                case "DomAAptas":
                    ...
                    axios.get('http://172.31.87.236:8080/api/dashboard/domAAptas/' + this.escola, { headers: { 'Authorization': this.token } })
                        .then(res => this.lista = res.data)
                        .catch(rej => console.log(rej));
                    break;
                case "DomARisco":
                    this.tituloListagem = 'Domingo A em Risco';
                    axios.get('http://172.31.87.236:8080/api/dashboard/domARisco/' + this.escola, { headers: { 'Authorization': this.token } })
                        .then(res => this.lista = res.data)
                        .catch(rej => console.log(rej));
                    break;
                case "DomBAptas":
                    this.tituloListagem = 'Domingo B Aptas';
                    axios.get('http://172.31.87.236:8080/api/dashboard/domBAptas/' + this.escola, { headers: { 'Authorization': this.token } })
                        .then(res => this.lista = res.data)
                        .catch(rej => console.log(rej));
                    break;
                case "DomBRisco":
                    this.tituloListagem = 'Domingo B em Risco';
                    axios.get('http://172.31.87.236:8080/api/dashboard/domBRisco/' + this.escola, { headers: { 'Authorization': this.token } })
                        .then(res => this.lista = res.data)
                        .catch(rej => console.log(rej));
                    break;
                case "DomCAptas":
                    this.tituloListagem = 'Domingo C Aptas';
                    axios.get('http://172.31.87.236:8080/api/dashboard/domCAptas/' + this.escola, { headers: { 'Authorization': this.token } })
                        .then(res => this.lista = res.data)
                        .catch(rej => console.log(rej));
                    break;
                case "DomCRisco":
                    this.tituloListagem = 'Domingo C em Risco';
                    axios.get('http://172.31.87.236:8080/api/dashboard/domCRisco/' + this.escola, { headers: { 'Authorization': this.token } })
                        .then(res => this.lista = res.data)
                        .catch(rej => console.log(rej));
                    break;
                case "DomDAptas":
                    this.tituloListagem = 'Domingo D Aptas';
                    axios.get('http://172.31.87.236:8080/api/dashboard/domDAptas/' + this.escola, { headers: { 'Authorization': this.token } })
                        .then(res => this.lista = res.data)
                        .catch(rej => console.log(rej));
                    break;
                case "DomDRisco":
                    this.tituloListagem = 'Domingo D em Risco';
                    axios.get('http://172.31.87.236:8080/api/dashboard/domDRisco/' + this.escola, { headers: { 'Authorization': this.token } })
                        .then(res => this.lista = res.data)
                        .catch(rej => console.log(rej));
                    break;
                case "TodosAptos":
                    this.tituloListagem = 'Todos Alunos Aptos';
                    axios.get('http://172.31.87.236:8080/api/dashboard/todosAptos/' + this.escola, { headers: { 'Authorization': this.token } })
                        .then(res => this.lista = res.data)
                        .catch(rej => console.log(rej));
                    break;
                case "TodosRisco":
                    this.tituloListagem = 'Todos Alunos em Risco';
                    axios.get('http://172.31.87.236:8080/api/dashboard/todosRisco/' + this.escola, { headers: { 'Authorization': this.token } })
                        .then(res => this.lista = res.data)
                        .catch(rej => console.log(rej));
                    break;
            }
