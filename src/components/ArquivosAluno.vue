...
export default {
    ...
    methods: {
        async iniciarUpload() {
            ...
            if (this.tipo === 'Foto') {
                axios.post('https://127.0.0.1:8443/api/arquivos/foto/' + this.codigoAluno + '/' + this.escola, formData, {
                    headers: {
                ...
                axios.post('https://127.0.0.1:8443/api/arquivos/matricula/' + this.codigoAluno + '/' + this.escola, formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data',
                        'Authorization': this.token
                    }
