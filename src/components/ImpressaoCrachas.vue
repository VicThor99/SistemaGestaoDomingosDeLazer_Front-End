...
export default {
    ...
    methods: {
        ...
        async imprimir() {
            ...
            if (this.domingo != '') {
                await axios.get('http://54.167.78.156:8080/api/jaspers/crachas/'+ this.escola + '?domingo=' + this.domingo + '&ativos=' + this.ativos, {
                    responseType: 'blob',
                ...
                await axios.get('http://54.167.78.156:8080/api/jaspers/crachas/'+ this.escola + '?serie=' + this.serie + '&ativos=' + this.ativos, {
                    responseType: 'blob',
                    headers: { 'Authorization': this.token }
                })
                    .then((response) => {
                ...
                await axios.get('http://54.167.78.156:8080/api/jaspers/crachas/'+ this.escola + '?sala=' + this.sala + '&ativos=' + this.ativos, {
                    responseType: 'blob',
                    headers: { 'Authorization': this.token }
                })
                    .then((response) => {
                ...
                await axios.get('http://54.167.78.156:8080/api/jaspers/crachas/'+ this.escola + '?codigo=' + this.codigo, {
                    responseType: 'blob',
                    headers: { 'Authorization': this.token }
                })
                    .then((response) => {
                ...
                await axios.get('http://54.167.78.156:8080/api/jaspers/crachas/'+ this.escola + '?ativos=' + this.ativos, {
                    responseType: 'blob',
                    headers: { 'Authorization': this.token }
                })
                    .then((response) => {
