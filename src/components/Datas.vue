    ...
    <div id="principal">
        ...
        <div id="data" v-if="dataAula != null">
            ...
            <div
                ...
                <div style="display: flex; justify-content: center; width: 40%; margin-bottom: 10px;">
...
export default {
    ...
    methods: {
        ...
        salvarData() {
            axios.post('http://localhost:8080/api/datas', this.dataAula).then(res => {
