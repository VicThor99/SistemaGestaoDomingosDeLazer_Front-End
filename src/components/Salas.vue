...
export default {
    ...
    methods: {
        async recarregaLista() {
            const res = await axios.get('http://172.31.87.236:8080/api/series/'+ this.escola, { headers: { 'Authorization': this.token } });
        ...
        salvarSerie() {
            axios.post('http://172.31.87.236:8080/api/series/'+ this.escola, this.serie, {
                headers: {
