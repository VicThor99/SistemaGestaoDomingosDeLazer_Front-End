...
export default {
    ...
    methods: {
        async recarregaLista() {
            const res = await axios.get('http://44.207.8.162:8080/api/series/'+ this.escola, { headers: { 'Authorization': this.token } });
        ...
        salvarSerie() {
            axios.post('http://44.207.8.162:8080/api/series/'+ this.escola, this.serie, {
                headers: {
