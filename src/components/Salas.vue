...
export default {
    ...
    methods: {
        async recarregaLista() {
            const res = await axios.get('http://54.87.114.106:8080/api/series/'+ this.escola, { headers: { 'Authorization': this.token } });
        ...
        salvarSerie() {
            axios.post('http://54.87.114.106:8080/api/series/'+ this.escola, this.serie, {
                headers: {
