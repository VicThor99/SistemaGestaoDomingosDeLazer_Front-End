...
export default {
    ...
    methods: {
        async recarregaLista() {
            const res = await axios.get('https://127.0.0.1:8443/api/series/'+ this.escola, { headers: { 'Authorization': this.token } });
        ...
        salvarSerie() {
            axios.post('https://127.0.0.1:8443/api/series/'+ this.escola, this.serie, {
                headers: {
