...
export default {
    ...
    methods: {
        ...
        async imprimir() {
            ...
            if (this.domingo != '') {
                await axios.get('https://54.167.78.156:8443/api/jaspers/listas/'+ this.escola + '?domingo=' + this.domingo + '&ativos=' + this.ativos, {
                    responseType: 'blob',
                ...
                await axios.get('https://54.167.78.156:8443/api/jaspers/listas/'+ this.escola + '?serie=' + this.serie + '&ativos=' + this.ativos, {
                    responseType: 'blob',
                    headers: { 'Authorization': this.token }
                })
                    .then((response) => {
                ...
                await axios.get('https://54.167.78.156:8443/api/jaspers/listas/'+ this.escola + '?sala=' + this.sala + '&ativos=' + this.ativos, {
                    responseType: 'blob',
                    headers: { 'Authorization': this.token }
                })
                    .then((response) => {
                ...
                await axios.get('https://54.167.78.156:8443/api/jaspers/listas/'+ this.escola + '?ativos=' + this.ativos, {
                    responseType: 'blob',
                    headers: { 'Authorization': this.token }
                })
                    .then((response) => {
