...
export default {
    ...
    methods: {
        async carregarListas() {
            const axSeries = await axios.get('http://3.95.225.147:8080/api/series/listaString/'+ this.escola, { headers: { 'Authorization': this.token } });
            const axSalas = await axios.get('http://3.95.225.147:8080/api/series/listaStringSalas/'+ this.escola, { headers: { 'Authorization': this.token } });
        ...
        async imprimir() {
            ...
            if (this.domingo != '') {
                await axios.get('http://3.95.225.147:8080/api/jaspers/protocolos/'+ this.escola + '?domingo=' + this.domingo + '&ativos=' + this.ativos, {
                    responseType: 'blob',
                ...
                await axios.get('http://3.95.225.147:8080/api/jaspers/protocolos/'+ this.escola + '?serie=' + this.serie + '&ativos=' + this.ativos, {
                    responseType: 'blob',
                    headers: { 'Authorization': this.token }
                })
                    .then((response) => {
                ...
                await axios.get('http://3.95.225.147:8080/api/jaspers/protocolos/'+ this.escola + '?sala=' + this.sala + '&ativos=' + this.ativos, {
                    responseType: 'blob',
                    headers: { 'Authorization': this.token }
                })
                    .then((response) => {
                ...
                await axios.get('http://3.95.225.147:8080/api/jaspers/protocolos/'+ this.escola + '?codigo=' + this.codigo, {
                    responseType: 'blob',
                    headers: { 'Authorization': this.token }
                })
                    .then((response) => {
                ...
                await axios.get('http://3.95.225.147:8080/api/jaspers/protocolos/'+ this.escola + '?ativos=' + this.ativos, {
                    responseType: 'blob',
                    headers: { 'Authorization': this.token }
                })
                    .then((response) => {
