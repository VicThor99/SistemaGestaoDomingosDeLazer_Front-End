...
export default {
    ...
    methods: {
        ...
        async salvarAluno() {
            ...
            if (this.aluno.id > 0) {
                await axios.post('https://www.domingodelazer.click:8443/api/registros/' + this.aluno.codigo + '/' + this.escola, this.registro, { headers: { 'Authorization': this.token } }).then(res => {
                    console.log(res);
                    axios.post('https://www.domingodelazer.click:8443/api/alunos/save', this.aluno, {
                        headers: {
                ...
                await axios.post('https://www.domingodelazer.click:8443/api/alunos/save', this.aluno, { headers: { 'Authorization': this.token } }).then(res => {
                    console.log(res);
                    axios.post('https://www.domingodelazer.click:8443/api/registros/' + res.data.codigo + '/' + this.escola, this.registro, {
                        headers: {
                            'Authorization': this.token
                        }
                    }).then(res => {
        ...
        async clickRow(item, row) {
            ...
            await axios.get('https://www.domingodelazer.click:8443/api/arquivos/foto/' + row.item.columns.id, {
                headers: {
                    'Authorization': this.token
                }
            })
            ...
            await axios.get('https://www.domingodelazer.click:8443/api/arquivos/matricula/' + row.item.columns.id, {
                headers: {
                    'Authorization': this.token
                }
            })
